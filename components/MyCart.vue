      ...
      <div class="container">
              ...
              <tr v-for="product in cartUpdate" :key="product.id">
                ...
                <td>
                  <button
                    ...
                    @click="$store.commit('decreaseQuantity', product)"
                    class="text-[#B00020] shadow p-4"
                  >
                    &#8211;
                  </button>
                  <button
                    @click="$store.commit('increaseQuantity', product)"
                    class="text-[#1B4B66] shadow p-4"
                  >
                    &#43;
                  </button>
                </td>
                <td>
                  ...
                  <button
                    @click="$store.commit('addToWishlist', product)"
                    class="text-[#1B4B66] shadow p-4"
                  >
        ...
        <div class="order">
          ...
          <div>
            ...
            <h4>
              ${{
                ($store.state.totalAmount - $store.state.discount).toFixed(2)
              }}
            </h4>
          </div>
          <div>
            <button
              ...
              class="bg-[#1B4B66] text-white"
            >
              Place Order
            </button>
            <button @click="$router.push('/store')" class="text-[#1B4B66]">
              Continue Shopping
            </button>
          </div>
        </div>
